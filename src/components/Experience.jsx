  ...
  const items = [
    {
      ...
      points: [
        'Developed various Apex classes and Apex Triggers on SalesCloud and Service Cloud for various functional needs.',
    ...
    },
    {
      ...
      points: [
        ...
        'Developed Asynchronous Apex such as Queueable Apex, Schedulable Apex for working on massive data records.',
    ...
    {
      title: 'SAP JavaScript Developer',
      company: 'NTT DATA Turkey',
      city: 'Istanbul',
